...
const showRecipe = async function() {
    try {
        ...
        const { recipe } = _modelJs.state; //trying to destructure the recipe object of the state object to see it's content.
        // Rendering Recipe
        const markup = `
        ...
        `;
        recipeContainer.innerHTML = ""; // Removing whatever it is inside the recipe container
        recipeContainer.insertAdjacentHTML("afterbegin", markup); // adding the html code as the first value of the recipe container.
    } catch (err) {
        alert(err);
    }
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../img/icons.svg":"cMpiy","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21"}],"gkKU3":[function(require,module,exports,__globalThis) {
